# -*- coding: utf-8 -*-
"""pgd_segmenter_week16.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GVwblzSdBlYU9gFrL7ds69cqXfe3EwKD
"""
...
exp_eps = int(sys.argv[2])

#exp_seg = 5 ## Always 6 for single PGD
seed_no_loc = 1

#exp_eps = 2 ## Always 1 for single segmenter
...
directory = "/cluster/scratch/pmayilvah/Week16_pgd_segmenter/"+str(exp_seg)+str(exp_eps)+"/"+str(seed_no_loc)+"/"
...
eps_stack_temp = [0.0, 0.1, 0.3, 0.5, 0.7, 0.9, 1.0]
...
params = ["True", 32, "CIFAR", 125, 50000, 1, 250, eps_stack_temp[exp_eps-1], [eps_stack_temp[exp_eps-1]], segments_stack[exp_seg-1], 0.1, 'L2PGD', 20, True, False, False, True, seed_no]
